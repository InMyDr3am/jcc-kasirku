...
<div class="container my-4">
    <div class="row">
        <h2 class="fs-3 text-center my-3">Pencarian Data Transaksi Berdasarkan Total Harga</h2>
        <div class="my-2">
            <form action="/transaksi-cari/totalharga" method="GET">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" name="total_awal">
                    <input type="text" class="form-control" name="total_akhir">
